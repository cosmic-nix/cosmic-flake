  ...
  internal = rec {
    ...
    crates = {
      ...
      "cc" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "1w1rf8i34p8mxsi74mzyrnla22mgkywjvw7p74s8rwlv25i2asvc";
        authors = [
      ...
      "cosmic-config" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "a223b60a0c60b982d4abf97a9c11ae52d9a392a5";
          sha256 = "0ds6mflk32472hk6bvhblczdjsc31smfp9y3kzaryizicwn7ayap";
        };
        dependencies = [
          {
            name = "atomicwrites";
      ...
      "rustix 0.38.6" = rec {
        ...
        version = "0.38.6";
        edition = "2021";
        sha256 = "0bvkmjppb3wazqb5zw8jczl05r29lx0k9c79mki802kgf6qj1q0y";
        authors = [
          "Dan Gohman <dev@sunfishcode.online>"
          "Jakub Konka <kubkon@jakubkonka.com>"
        ];
      ...
      "serde" = rec {
        ...
        version = "1.0.180";
        edition = "2018";
        sha256 = "1vdkcc4d1vdbkiaw9fli7f4l0f00irwf5iiy9s5fi3q57wc7z9hf";
        authors = [
      ...
      "serde_derive" = rec {
        ...
        version = "1.0.180";
        edition = "2015";
        sha256 = "0dlh47jnacckz53kzvdvb87cqnbid42yyrrjnyrnls1bg3bl9rr4";
        procMacro = true;
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
      ...
      "winnow" = rec {
        ...
        version = "0.5.3";
        edition = "2021";
        sha256 = "01yqnmvccwicddwxnl4cxrrv12r24sxfr6js0yrdgr04jdssnspl";
        dependencies = [
          {
            name = "memchr";
            packageId = "memchr";
