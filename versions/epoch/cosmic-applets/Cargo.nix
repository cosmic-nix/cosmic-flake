  ...
  internal = rec {
    ...
    crates = {
      ...
      "cfg-expr" = rec {
        ...
        version = "0.15.3";
        edition = "2021";
        sha256 = "0744z7sky6kgchfk2ilchb16bjyz7nk8p8zfn3p953y2xir00p11";
        authors = [
      ...
      "cosmic-applet" = rec {
        crateName = "cosmic-applet";
        version = "0.1.0";
        edition = "2021";
        # We can't filter paths with references in Nix 2.4
        # See https://github.com/NixOS/nix/issues/5410
        src = if ((lib.versionOlder builtins.nixVersion "2.4pre20211007") || (lib.versionOlder "2.5" builtins.nixVersion ))
          then lib.cleanSourceWith { filter = sourceFilter;  src = ./applet; }
          else ./applet;
        dependencies = [
          {
      ...
      "cosmic-config" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "f77bd443d7f4c074040b3b8cc09ed35bd1ca3983";
          sha256 = "1rya5nk95ih4z0qkd7vpgg89x3cir72nksccnjarz9qm6qj9vahf";
        };
        dependencies = [
          {
            name = "atomicwrites";
      ...
      "cosmic-notifications-config" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "82b55a63c9d0b00f7d752f1dc9b9291742888e5f";
          sha256 = "1v7qff72j9nji9gwgajwn51171zhqwlvh871m0iw67kkirz2140n";
        };
        dependencies = [
          {
            name = "cosmic-config";
      ...
      "cosmic-time" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "c39e737fc55f6c3cbb03a309627da5c525bddd6d";
          sha256 = "1yz1msffhyaarwv4fj0wd5c9l0d33lv097dyfvi28ij6n91d0id5";
        };
        authors = [
        ...
        features = {
          "default" = [ "libcosmic" ];
          "iced" = [ "dep:iced" "dep:iced_native" "dep:iced_futures" "dep:iced_core" "dep:iced_style" ];
      ...
      "glib" = rec {
        ...
        version = "0.18.0";
        edition = "2021";
        sha256 = "02829xxc8h5hjkqrxamm2h2lxmsn601lkx0105m74wz5ghx0drvh";
        authors = [
      ...
      "glib-sys" = rec {
        ...
        version = "0.18.0";
        edition = "2021";
        sha256 = "0k7s3cqc73iyj14wzax57l3nlk5bafs8j2fjxw79n67y3fjipgvi";
        libName = "glib_sys";
        authors = [
          "The gtk-rs Project Developers"
        ];
      ...
      "logind-zbus" = rec {
        ...
        version = "3.1.0";
        edition = "2021";
        sha256 = "1qwgn7j931kha2cabpjnvsr6khhjwn6c0kilswm013awaragqb1z";
        authors = [
      ...
      "serde" = rec {
        ...
        version = "1.0.175";
        edition = "2015";
        sha256 = "02zzxg8hlg2b06yrgl6n0fvmvs5m68jgx9j84x708z9rsyf469ax";
        authors = [
      ...
      "serde_derive" = rec {
        ...
        version = "1.0.175";
        edition = "2015";
        sha256 = "1d0ar34z5gbincb8mdgaa3sl242cp6wdsn1qsv0161hidzg7lgxj";
        procMacro = true;
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
      ...
      "serde_repr" = rec {
        ...
        version = "0.1.15";
        edition = "2021";
        sha256 = "1rc5mxyx7860ndhx31zxyhcy022p92853c7y6xhbvyg8f6pyls71";
        procMacro = true;
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
      ...
      "target-lexicon" = rec {
        ...
        version = "0.12.10";
        edition = "2018";
        sha256 = "13mf96n5sqlwb4v7vqw522fzkfp0k36s9camaa9qkasrazpswbqx";
        authors = [
      ...
      "xdg-shell-wrapper-config" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "8024f9e33fdbf188c34543566102dfb7755adf7a";
          sha256 = "1qwmr30z190scrawy2f05kc0lv4yi7h40w2ap40cfd1dym2rbc45";
        };
        dependencies = [
          {
            name = "serde";
