...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "current_locale" = rec {
        crateName = "current_locale";
        version = "0.1.1";
        edition = "2018";
        sha256 = "046d0bsf4373991m586s0is8aybwxb72391iis6yd2ysrkf8vgp0";
        authors = [
          "i509VCB <git@i509.me>"
        ];
        dependencies = [
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "bytes" "default" "libc" "mio" "num_cpus" "process" "rt" "rt-multi-thread" "signal-hook-registry" "sync" "time" "windows-sys" ];
      };
      "toml 0.5.11" = rec {
        crateName = "toml";
        version = "0.5.11";
