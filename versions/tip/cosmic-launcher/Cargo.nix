    ...
    crates = {
      ...
      "cosmic-config" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "6457481ae5c1435526a8538bc792ebc55c6dff02";
          sha256 = "0vw36lzglhaqkym36hdvc4xpcii19bzjl00grvgjw8xh7sdxv8zl";
        };
        dependencies = [
          {
            name = "atomicwrites";
      ...
      "libcosmic" = rec {
        ...
        resolvedDefaultFeatures = [ "ashpd" "iced_sctk" "sctk" "tokio" "wayland" ];
      };
      ...
      "pin-project 1.1.3" = rec {
        ...
        dependencies = [
          {
            name = "pin-project-internal";
            packageId = "pin-project-internal 1.1.3";
          }
        ];
      ...
      "pin-project-internal 1.1.3" = rec {
        crateName = "pin-project-internal";
        version = "1.1.3";
        edition = "2021";
      ...
      "serde" = rec {
        ...
        version = "1.0.186";
        edition = "2018";
        sha256 = "1hdphc7iicvpwd631abahpgx5dpl70lznsaysjdxw2f0411b4pcz";
        authors = [
      ...
      "serde_derive" = rec {
        ...
        version = "1.0.186";
        edition = "2015";
        sha256 = "0w76p0brqqqkgrmbylb6qg9yhmxksmpgbs2c7acg8nmnw3vrgmjs";
        procMacro = true;
        authors = [
          "Erick Tryzelaar <erick.tryzelaar@gmail.com>"
          "David Tolnay <dtolnay@gmail.com>"
      ...
      "time-macros" = rec {
        ...
        version = "0.2.13";
        edition = "2021";
        sha256 = "1yg8wgynbh663y2rpijhjd49q2vvs0q55dwl5cwksc79aa3jagbk";
        procMacro = true;
        authors = [
          "Jacob Pratt <open-source@jhpratt.dev>"
          "Time contributors"
      ...
      "windows-sys 0.45.0" = rec {
        ...
        resolvedDefaultFeatures = [ "Win32" "Win32_Globalization" "Win32_System" "Win32_System_SystemServices" "default" ];
      };
