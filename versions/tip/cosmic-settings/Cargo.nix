...
rec {
  ...
  workspaceMembers = {
    ...
    "cosmic-settings-desktop" = rec {
      packageId = "cosmic-settings-desktop";
      build = internal.buildRustCrateWithFeatures {
        packageId = "cosmic-settings-desktop";
      };
    ...
    "cosmic-settings-page" = rec {
      packageId = "cosmic-settings-page";
      build = internal.buildRustCrateWithFeatures {
        packageId = "cosmic-settings-page";
      };
    ...
    "cosmic-settings-system" = rec {
      packageId = "cosmic-settings-system";
      build = internal.buildRustCrateWithFeatures {
        packageId = "cosmic-settings-system";
      };
    ...
    "cosmic-settings-time" = rec {
      packageId = "cosmic-settings-time";
      build = internal.buildRustCrateWithFeatures {
        packageId = "cosmic-settings-time";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bitflags 2.3.2" = rec {
        ...
        version = "2.3.2";
        edition = "2021";
        sha256 = "1vdd75jz031jyjp8fai3kzhg8b97m0a058nb5rak30hpkjbkrgkd";
        authors = [
          "The Rust Project Developers"
        ];
        features = {
      ...
      "clipboard_wayland" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "0ir7j7glad3p1mf5xb66jqj6ys3bgwfam650l70jlvx6yyln8qvg";
        authors = [
          "Héctor Ramón Jiménez <hector0193@gmail.com>"
        ];
        dependencies = [
      ...
      "clipboard_x11" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "08g94h0n0jmjvhmphzhpf8ax5ibfnl67mln6wbfh9kbfhc870flq";
        authors = [
          "Héctor Ramón Jiménez <hector0193@gmail.com>"
        ];
        dependencies = [
      ...
      "concat-in-place" = rec {
        crateName = "concat-in-place";
        version = "1.1.0";
        edition = "2018";
        sha256 = "0c5l6syg7r0xzmbsycah2zl7f4bzhcmk3l1ad55hqvnjcnx0vf65";
        authors = [
      ...
      "cosmic-bg-config" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "4e1652f06bacc545eced24b11cb639ecead3b90c";
          sha256 = "1v3h92iqqv7y9ga0cglhqpspv72db2f8rs85pb5m3kyv71gkbm3s";
        };
        dependencies = [
          {
            name = "colorgrad";
      ...
      "cosmic-panel-config" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "22571fe4d9496439f6940c4358751424552f84cd";
          sha256 = "02b7kv338jwy2mr26d32bwc7xx44rbi846bc3y1x15lh4hncsb0a";
        };
        dependencies = [
          {
            name = "anyhow";
      ...
      "cosmic-settings-desktop" = rec {
        crateName = "cosmic-settings-desktop";
        version = "0.1.0";
        edition = "2021";
        # We can't filter paths with references in Nix 2.4
        # See https://github.com/NixOS/nix/issues/5410
        src = if ((lib.versionOlder builtins.nixVersion "2.4pre20211007") || (lib.versionOlder "2.5" builtins.nixVersion ))
          then lib.cleanSourceWith { filter = sourceFilter;  src = ./pages/desktop; }
          else ./pages/desktop;
        dependencies = [
          {
      ...
      "cosmic-settings-page" = rec {
        crateName = "cosmic-settings-page";
        version = "0.1.0";
        edition = "2021";
        # We can't filter paths with references in Nix 2.4
        # See https://github.com/NixOS/nix/issues/5410
        src = if ((lib.versionOlder builtins.nixVersion "2.4pre20211007") || (lib.versionOlder "2.5" builtins.nixVersion ))
          then lib.cleanSourceWith { filter = sourceFilter;  src = ./page; }
          else ./page;
        dependencies = [
          {
            name = "derive_setters";
      ...
      "cosmic-settings-system" = rec {
        crateName = "cosmic-settings-system";
        version = "0.1.0";
        edition = "2021";
        # We can't filter paths with references in Nix 2.4
        # See https://github.com/NixOS/nix/issues/5410
        src = if ((lib.versionOlder builtins.nixVersion "2.4pre20211007") || (lib.versionOlder "2.5" builtins.nixVersion ))
          then lib.cleanSourceWith { filter = sourceFilter;  src = ./pages/system; }
          else ./pages/system;
        dependencies = [
          {
            name = "bumpalo";
      ...
      "cosmic-settings-time" = rec {
        crateName = "cosmic-settings-time";
        version = "0.1.0";
        edition = "2021";
        # We can't filter paths with references in Nix 2.4
        # See https://github.com/NixOS/nix/issues/5410
        src = if ((lib.versionOlder builtins.nixVersion "2.4pre20211007") || (lib.versionOlder "2.5" builtins.nixVersion ))
          then lib.cleanSourceWith { filter = sourceFilter;  src = ./pages/time; }
          else ./pages/time;
        dependencies = [
          {
            name = "icu_calendar";
          ...
          {
            name = "icu_timezone";
            packageId = "icu_timezone";
          }
          {
            name = "timedate-zbus";
            packageId = "timedate-zbus";
          }
          {
            name = "zbus";
            packageId = "zbus";
      ...
      "crossfont" = rec {
        ...
        version = "0.5.1";
        edition = "2021";
        sha256 = "0icwpj9plf7bs0k34x86c58bwqyx2j3ji98aaahsncga6vfkmz91";
        authors = [
        ...
        dependencies = [
          ...
          }
          {
            ...
            target = { target, features }: (!(("macos" == target."os") || (target."windows" or false)));
          }
          {
            name = "libc";
            packageId = "libc";
      ...
      "darling 0.20.1" = rec {
        ...
        dependencies = [
          {
            name = "darling_core";
            packageId = "darling_core 0.20.1";
          }
          {
            name = "darling_macro";
            packageId = "darling_macro 0.20.1";
          }
        ];
        features = {
          "default" = [ "suggestions" ];
      ...
      "etagere" = rec {
        ...
        version = "0.2.7";
        edition = "2018";
        sha256 = "128wc2wjfjrsvfq1skf4mgcwr9gv3kmmnf9i5hwpydlg64d1a0b3";
        authors = [
          "Nicolas Silva <nical@fastmail.com>"
        ];
        dependencies = [
      ...
      "glow" = rec {
        ...
        version = "0.12.2";
        edition = "2021";
        sha256 = "0qpp0yikvqjkyz2hsqs54sh3pnyv74cgwffxh4hmn2qcnxcdyzl0";
        authors = [
      ...
      "iced" = rec {
        ...
        resolvedDefaultFeatures = [ "debug" "iced_sctk" "image" "image_rs" "lazy" "svg" "tokio" "wayland" ];
      };
      ...
      "iced_runtime" = rec {
        ...
        resolvedDefaultFeatures = [ "debug" "sctk" "wayland" ];
      };
      "iced_sctk" = rec {
        crateName = "iced_sctk";
        version = "0.1.0";
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "wayland-protocols 0.30.0";
            features = [ "staging" ];
          }
        ];
        features = {
      ...
      "iced_winit" = rec {
        ...
        resolvedDefaultFeatures = [ "application" "debug" "default" "wayland" "wayland-csd-adwaita" "wayland-dlopen" "x11" ];
      };
      "icu_calendar" = rec {
        crateName = "icu_calendar";
        version = "1.2.0";
        edition = "2021";
        sha256 = "0609bvga4bay90kwpyf1mb0nsy1608fcln1d7v846iylbv1fiqfy";
        authors = [
      ...
      "icu_locid" = rec {
        ...
        version = "1.2.0";
        edition = "2021";
        sha256 = "0dfks7scwwxr410bl9b19rps8lwiqm434sb7yn7j63pwrifzh0rh";
        authors = [
          "The ICU4X Project Developers"
        ];
        dependencies = [
      ...
      "icu_provider" = rec {
        ...
        version = "1.2.0";
        edition = "2021";
        sha256 = "01g3fsrhs02kyga5iplayhs40bfijhjawiw017z7v3qlnski5hwd";
        authors = [
          "The ICU4X Project Developers"
        ];
        dependencies = [
      ...
      "icu_provider_macros" = rec {
        ...
        version = "1.2.0";
        edition = "2021";
        sha256 = "043y9823gww3bijmrja80xg79ykq3c8831lz3pzkxs91jj5p52yx";
        procMacro = true;
        authors = [
          "The ICU4X Project Developers"
        ];
      ...
      "icu_timezone" = rec {
        crateName = "icu_timezone";
        version = "1.2.0";
        edition = "2021";
        sha256 = "0xqrn290j3i6bw0xpzqzpjkvmxd1w6lyyf0q2ra2vpjhlisxl8jy";
        authors = [
          "The ICU4X Project Developers"
        ];
        dependencies = [
      ...
      "libcosmic" = rec {
        ...
        resolvedDefaultFeatures = [ "debug" "iced_sctk" "sctk" "tokio" "wayland" ];
      };
      ...
      "litemap" = rec {
        ...
        version = "0.7.0";
        edition = "2021";
        sha256 = "154g9q1iqa7vpssjmjiq540ri7f5lv892r4jk6lcnjpmnsraa11s";
        authors = [
          "The ICU4X Project Developers"
        ];
        features = {
      ...
      "naga" = rec {
        ...
        version = "0.12.2";
        edition = "2021";
        sha256 = "13lk0vw737cc4d511bynbgfp73bblicd43h23h7pka40c6yh1kc0";
        authors = [
          "Naga Developers"
        ];
        dependencies = [
      ...
      "rust-embed" = rec {
        ...
        version = "6.7.0";
        edition = "2018";
        sha256 = "1hsd99iz14m480zr4qiyrwz31saakdckn8lg510k2dcc90gp4gmp";
        authors = [
      ...
      "rust-embed-impl" = rec {
        ...
        version = "6.6.0";
        edition = "2018";
        sha256 = "1dajakm6b6jjv8sy7rhh8aw74hvs6425ancnj64266anymif6b72";
        procMacro = true;
        authors = [
          "pyros2097 <pyros2097@gmail.com>"
        ];
      ...
      "rust-embed-utils" = rec {
        ...
        version = "7.5.0";
        edition = "2018";
        sha256 = "0cbp7whwhfjmlqamkak6xnfbnj7psr1wnjkmr3ii8zizhnv0lasi";
        authors = [
          "pyros2097 <pyros2097@gmail.com>"
        ];
        dependencies = [
      ...
      "serde_repr" = rec {
        ...
        version = "0.1.12";
        edition = "2018";
        sha256 = "1aqcsjq5wc51qnflfqzkkrh5ckcmi3c7ypx2amg0i1664088iv5w";
        procMacro = true;
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
      ...
      "smithay-client-toolkit 0.17.0" = rec {
        ...
        workspace_member = null;
        src = pkgs.fetchgit {
          url = "https://github.com/pop-os/client-toolkit";
          rev = "fd15dd954bc5f0c78d079aeda7b11194a682bbff";
          sha256 = "1vzh0nqldbag8lrsqw4acyy5ab2i8lsw52sigzssnhlbj6wgj127";
        };
        authors = [
          "Elinor Berger <elinor@safaradeg.net>"
      ...
      "sysinfo" = rec {
        ...
        version = "0.29.2";
        edition = "2018";
        sha256 = "15c6ld3fa53pj7sbcdyrkz6vckr143qxy43v5wcaivl6bf2d0mwm";
        authors = [
      ...
      "timedate-zbus" = rec {
        crateName = "timedate-zbus";
        version = "0.1.0";
        edition = "2021";
        sha256 = "1dw5q7phm54vi1b3ihgxnpxbz4528fc1ajmck5wy5ng1ib255430";
        dependencies = [
          {
            name = "zbus";
            packageId = "zbus";
      ...
      "tiny-skia 0.7.0" = rec {
        ...
        dependencies = [
          ...
          {
            name = "tiny-skia-path";
            packageId = "tiny-skia-path 0.7.0";
            usesDefaultFeatures = false;
          }
        ];
        features = {
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "bytes" "default" "fs" "io-util" "libc" "mio" "net" "num_cpus" "process" "rt" "rt-multi-thread" "signal-hook-registry" "socket2" "sync" "time" "tracing" "windows-sys" ];
      };
      "toml 0.5.11" = rec {
        crateName = "toml";
        version = "0.5.11";
      ...
      "unicode-linebreak" = rec {
        ...
        version = "0.1.4";
        edition = "2021";
        sha256 = "0drixqb16bzmabd5d8ldvar5760rxy6nxzszhlsqnasl3bisvyn5";
        authors = [
      ...
      "wgpu" = rec {
        ...
        version = "0.16.1";
        edition = "2021";
        sha256 = "15fazjxbjvsjxmkkh9wiiw58rqz7cnpy4cv86m7s2764vr6yln9h";
        authors = [
          "wgpu developers"
        ];
        dependencies = [
      ...
      "wgpu-hal" = rec {
        ...
        version = "0.16.1";
        edition = "2021";
        sha256 = "196gc9rp2x9rx36xxp259a91rcsn0qdx8hf2fhp6b5sxiqn1r1bl";
        authors = [
          "wgpu developers"
        ];
        dependencies = [
      ...
      "wgpu-types" = rec {
        ...
        version = "0.16.0";
        edition = "2021";
        sha256 = "0ax3m72bggqlvdkziaphhspmvh1z1h683crrrp6kvw1hc6bkmlsv";
        authors = [
          "wgpu developers"
        ];
        dependencies = [
      ...
      "window_clipboard" = rec {
        ...
        version = "0.3.0";
        edition = "2021";
        sha256 = "0zgzfg46bb5pg2m5wzv3fy1y3ngar87rnnh3dlsgbk4n8ff7qa33";
        authors = [
          "Héctor Ramón Jiménez <hector0193@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            target = { target, features }: ((target."unix" or false) && (!(("macos" == target."os") || ("android" == target."os") || ("emscripten" == target."os") || ("ios" == target."os") || ("redox" == target."os"))));
          }
          {
            name = "clipboard_x11";
      ...
      "windows-sys 0.45.0" = rec {
        ...
        resolvedDefaultFeatures = [ "Win32" "Win32_Foundation" "Win32_Globalization" "Win32_Security" "Win32_Storage" "Win32_Storage_FileSystem" "Win32_System" "Win32_System_IO" "Win32_System_SystemServices" "Win32_System_Threading" "Win32_System_WindowsProgramming" "default" ];
      };
      ...
      "winit" = rec {
        ...
        workspace_member = null;
        src = pkgs.fetchgit {
          url = "https://github.com/pop-os/winit.git";
          rev = "d35712bba65eb1dad8f6f546af49b96fdad9467e";
          sha256 = "1hvmbgnc7f1fg0zv0g7bx1mila6ipdnvidd92243vs4cwqrch17b";
        };
        authors = [
      ...
      "winnow" = rec {
        ...
        version = "0.4.1";
        edition = "2021";
        sha256 = "0a2b9f0n6fpn2a88jfbp1kdjj6xrhvf8arnny67qsjb6djrp12df";
        dependencies = [
          {
            name = "memchr";
            packageId = "memchr";
      ...
      "writeable" = rec {
        ...
        version = "0.5.2";
        edition = "2021";
        sha256 = "03ysq0ghn3zbhqibivx3vwpd6507iwpi0y6dyivdrmdipm19xr30";
        authors = [
          "The ICU4X Project Developers"
        ];
        features = {
      ...
      "x11rb 0.9.0" = rec {
        ...
        version = "0.9.0";
        edition = "2018";
        sha256 = "12kdvzjfdbv9nkliq9lk6jd70f71q1qaiya24fjy4flbciavx6bf";
        authors = [
          "Uli Schlachter <psychon@znc.in>"
      ...
      "xdg" = rec {
        ...
        version = "2.5.0";
        edition = "2018";
        sha256 = "1vkzfsy3n85qnn1076h9111jg3h7k9r99jqi8nnrq3kmbbdrg1b8";
        authors = [
      ...
      "xdg-shell-wrapper-config" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "39880a3cf2a11ea969616d8b961289519bbeb742";
          sha256 = "10ir6yj465ycs1kjj6dxqbs1ymfp2c67bfxj8a8lvma1lcxrmb0y";
        };
        dependencies = [
          {
            name = "serde";
      ...
      "xml-rs" = rec {
        ...
        edition = "2021";
        crateBin = [];
        sha256 = "072lwmk6y84gha04rr13z44y9daq3yfh6kgs7vv8wfh8274rv0sj";
        libName = "xml";
        authors = [
      ...
      "yoke" = rec {
        ...
        version = "0.7.1";
        edition = "2021";
        sha256 = "1plmwim3rcqa455gik60z3abmz2qrzra1scf95rrg3x24dd0fj0q";
        authors = [
          "Manish Goregaokar <manishsmail@gmail.com>"
        ];
        dependencies = [
      ...
      "yoke-derive" = rec {
        ...
        version = "0.7.1";
        edition = "2021";
        sha256 = "18mpypz6xpcxni3bx3j5aygj46v5s9b2p8qaxxp53mryj9lw2img";
        procMacro = true;
        authors = [
          "Manish Goregaokar <manishsmail@gmail.com>"
        ];
      ...
      "zbus" = rec {
        ...
        version = "3.13.1";
        edition = "2018";
        sha256 = "0adbvblnn30qjinyl7iiyz8qj4anlp2vdw0734gk4a3cjv4pfgbc";
        authors = [
          "Zeeshan Ali Khan <zeeshanak@gnome.org>"
        ];
        dependencies = [
        ...
        features = {
          ...
          "async-io" = [ "dep:async-io" "async-executor" "async-task" "async-lock" "async-fs" "futures-util/io" ];
        ...
        resolvedDefaultFeatures = [ "async-executor" "async-fs" "async-io" "async-lock" "async-task" "default" "tokio" ];
      };
      "zbus_macros" = rec {
        crateName = "zbus_macros";
        version = "3.13.1";
        edition = "2018";
        sha256 = "1brmniak38sx05z3vvc4k962j08n2rzvzjwwad769zys5v8l3qzn";
        procMacro = true;
        authors = [
      ...
      "zbus_names" = rec {
        ...
        version = "2.5.1";
        edition = "2018";
        sha256 = "0amcfyxcacf1ki1j9a7kk2b52zcmwjim2ad7aw8p82my6dh1wi42";
        authors = [
          "Zeeshan Ali Khan <zeeshanak@gnome.org>"
        ];
        dependencies = [
      ...
      "zerofrom" = rec {
        ...
        version = "0.1.2";
        edition = "2021";
        sha256 = "18mylrn6zii17vcpzka94pxxlwn16vk23kpwbmhjgpji69ndfm6z";
        authors = [
          "Manish Goregaokar <manishsmail@gmail.com>"
        ];
        dependencies = [
      ...
      "zerofrom-derive" = rec {
        ...
        version = "0.1.2";
        edition = "2021";
        sha256 = "16f4l6sk5h121p2k3bl110jjzp4x8iqhgg16wpyfmf6lyz0ygsml";
        procMacro = true;
        authors = [
          "Manish Goregaokar <manishsmail@gmail.com>"
        ];
      ...
      "zerovec" = rec {
        ...
        version = "0.9.4";
        edition = "2021";
        sha256 = "1sn8czjxh5fx9i21n5pfd17ay66m18yv98qah8vz8rfq9h9m93qr";
        authors = [
          "The ICU4X Project Developers"
        ];
        dependencies = [
      ...
      "zerovec-derive" = rec {
        ...
        version = "0.9.4";
        edition = "2021";
        sha256 = "1b0vwmc6mwzmp94wj96r772ipchvgi83cafbz3811pjx5mrmhra8";
        procMacro = true;
        authors = [
          "Manish Goregaokar <manishsmail@gmail.com>"
        ];
      ...
      "zvariant" = rec {
        ...
        version = "3.14.0";
        edition = "2018";
        sha256 = "0g7rz64a1gccvnbw43m4mv7vs3p3dck4mcxpfc6ipvqcy5rw8b32";
        authors = [
          "Zeeshan Ali Khan <zeeshanak@gnome.org>"
        ];
        dependencies = [
      ...
      "zvariant_derive" = rec {
        ...
        version = "3.14.0";
        edition = "2018";
        sha256 = "18ixfzkwqlx115lx97f0gzxwxds48wy1yrkw4mwbf99c6mbip72x";
        procMacro = true;
        authors = [
          "Zeeshan Ali Khan <zeeshanak@gnome.org>"
        ];
