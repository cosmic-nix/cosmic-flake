...
rec {
  ...
  rootCrate = rec {
    packageId = "xdg-desktop-portal-cosmic";
    ...
    crates = {
      ...
      "ashpd" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "62142f7805315780a08d70868f2d1fd08bbdebf9";
          sha256 = "18380zli0kiwwwm3qfkdl3js8mp19gjf78paclvfrymnj80g50pj";
        };
        authors = [
      ...
      "libspa" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "40512adec8a13891b47aa900568191bb728a84b6";
          sha256 = "0yakd3k9sccxnfdsihvbg090ff07vgh0c68vwlyw140gvv38yb16";
        };
        authors = [
      ...
      "wayland-protocols" = rec {
        ...
        resolvedDefaultFeatures = [ "client" "server" "unstable" "wayland-client" "wayland-server" ];
      };
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "combaseapi" "handleapi" "iphlpapi" "knownfolders" "memoryapi" "minwinbase" "ntdef" "processthreadsapi" "sddl" "securitybaseapi" "shlobj" "synchapi" "tcpmib" "winbase" "winerror" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      ...
      "windows-sys" = rec {
        ...
        resolvedDefaultFeatures = [ "Win32" "Win32_Foundation" "Win32_NetworkManagement" "Win32_NetworkManagement_IpHelper" "Win32_Networking" "Win32_Networking_WinSock" "Win32_Security" "Win32_Storage" "Win32_Storage_FileSystem" "Win32_System" "Win32_System_Diagnostics" "Win32_System_Diagnostics_Debug" "Win32_System_IO" "Win32_System_LibraryLoader" "Win32_System_Pipes" "Win32_System_SystemServices" "Win32_System_Threading" "Win32_System_WindowsProgramming" "default" ];
      };
      "windows-targets" = rec {
      ...
      "xdg-desktop-portal-cosmic" = rec {
        crateName = "xdg-desktop-portal-cosmic";
        version = "0.1.0";
        edition = "2021";
        crateBin = [
          {
      ...
      "zbus" = rec {
        ...
        resolvedDefaultFeatures = [ "async-executor" "async-fs" "async-io" "async-lock" "async-task" "blocking" "tokio" "url" ];
      };
      "zbus_macros" = rec {
