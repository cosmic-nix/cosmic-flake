  ...
  internal = rec {
    ...
    crates = {
      ...
      "calloop" = rec {
        ...
        resolvedDefaultFeatures = [ "executor" "futures-util" ];
      };
      "cc" = rec {
        crateName = "cc";
        version = "1.0.79";
      ...
      "cosmic-comp" = rec {
        ...
        dependencies = [
          ...
          {
            name = "puffin";
            packageId = "puffin 0.14.3";
            optional = true;
          }
          {
            name = "puffin_egui";
            packageId = "puffin_egui";
            optional = true;
          }
          {
            name = "regex";
        ...
        features = {
          ...
          "default" = [ "systemd" ];
          "egui" = [ "dep:egui" ];
          "libsystemd" = [ "dep:libsystemd" ];
          "puffin" = [ "dep:puffin" ];
          "puffin_egui" = [ "dep:puffin_egui" ];
          "renderdoc" = [ "dep:renderdoc" ];
          "smithay-egui" = [ "dep:smithay-egui" ];
          "systemd" = [ "libsystemd" ];
        };
        resolvedDefaultFeatures = [ "debug" "default" "egui" "libsystemd" "puffin" "puffin_egui" "renderdoc" "smithay-egui" "systemd" ];
      };
      "cosmic-config" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "42d7baf0d5cb14ab476120be9dfcaea9bd1d0be4";
          sha256 = "11s95sjbzl09ibcvcv3wv6p1ibgridjky3fxsw16hk7fw2bzyvdq";
        };
        dependencies = [
          {
            name = "atomicwrites";
      ...
      "cosmic-text" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          sha256 = "05jzxzl06367pfki0pd8jxhdc3g3k0kyxhljwijzg3kc62dgxryy";
        };
        authors = [
        ...
        features = {
          ...
          "std" = [ "fontdb/memmap" "fontdb/std" "ouroboros/std" "rustybuzz/std" "sys-locale" "unicode-bidi/std" ];
          "swash" = [ "dep:swash" ];
          "syntect" = [ "dep:syntect" ];
      ...
      "deranged" = rec {
        ...
        version = "0.3.6";
        edition = "2021";
        sha256 = "009w5a7fhf8wwvgjxl4n5ijblry3is8690nna2diwnrqrziff448";
        authors = [
      ...
      "egui_extras" = rec {
        ...
        version = "0.22.0";
        edition = "2021";
        sha256 = "00nfz89syl5c45bwgz7rx1pgl4d381rmlpipwmbhsvsjgcrz8y4j";
        authors = [
        ...
        dependencies = [
          ...
          {
            name = "tiny-skia";
            packageId = "tiny-skia 0.8.4";
            optional = true;
            usesDefaultFeatures = false;
          }
          {
            name = "usvg";
            packageId = "usvg 0.28.0";
            optional = true;
            usesDefaultFeatures = false;
          }
        ];
        ...
        resolvedDefaultFeatures = [ "default" "resvg" "svg" "tiny-skia" "usvg" ];
      };
      "egui_glow" = rec {
        crateName = "egui_glow";
        version = "0.22.0";
      ...
      "fontconfig-parser" = rec {
        ...
        version = "0.5.2";
        edition = "2018";
        sha256 = "0ak7ank5p2q0ky8pa1c9rpfrfizs1ip8pavnp3f6c4vnc8ky3cja";
        dependencies = [
          {
            name = "roxmltree";
            packageId = "roxmltree 0.18.0";
          }
        ];
        features = {
          "log" = [ "dep:log" ];
      ...
      "glyphon" = rec {
        ...
        workspace_member = null;
        src = pkgs.fetchgit {
          url = "https://github.com/hecrj/glyphon.git";
          rev = "26f92369da3704988e3e27f0b35e705c6b2de203";
          sha256 = "18ph2nhb8rnnzvg9szybai04pxsz4gqykwzblxkmi5vxbxcamgc7";
        };
        dependencies = [
          {
            name = "cosmic-text";
      ...
      "iced" = rec {
        ...
        resolvedDefaultFeatures = [ "image" "image_rs" "lazy" "svg" ];
      };
      "iced_core" = rec {
        crateName = "iced_core";
        version = "0.9.0";
        ...
        resolvedDefaultFeatures = [ "palette" ];
      };
      "iced_futures" = rec {
      ...
      "iced_graphics" = rec {
        ...
        resolvedDefaultFeatures = [ "image" "kamadak-exif" "tiny-skia" ];
      };
      "iced_renderer" = rec {
      ...
      "iced_widget" = rec {
        ...
        resolvedDefaultFeatures = [ "image" "lazy" "ouroboros" "svg" ];
      };
      "id_tree" = rec {
        crateName = "id_tree";
        version = "1.8.0";
        ...
        workspace_member = null;
        src = pkgs.fetchgit {
          url = "https://github.com/Drakulix/id-tree.git";
          rev = "632a57d6d49160e18d7300fa7edae52281ec5482";
          sha256 = "0gcd6vrlvbzqvglplfzvmbjii9nxw9x8d8q3dbpxs6ng2wflm9xq";
        };
        authors = [
      ...
      "imagesize 0.10.1" = rec {
        crateName = "imagesize";
        version = "0.10.1";
        edition = "2018";
        sha256 = "0lfrrjqk3pqjk6cyr051fbpg7cc1afaj5mlpr91w1zpvj8gdl6fz";
        authors = [
          "Maid Dog <maiddogsrl@gmail.com>"
        ];

      };
      "imagesize 0.11.0" = rec {
        crateName = "imagesize";
        version = "0.11.0";
        edition = "2018";
      ...
      "input" = rec {
        ...
        version = "0.8.3";
        edition = "2018";
        sha256 = "0ndhy09m3n2wphn784ic9n61i3y4plvq6aklg3dndkgd5kc4rrz6";
        authors = [
      ...
      "input-sys" = rec {
        ...
        version = "1.17.0";
        edition = "2018";
        sha256 = "1hnx7xh8dcvnxwh8cjqxh6nyn3vvz0x8cchfcqbp5flagshw5xh5";
        authors = [
          "Victoria Brekenfeld (Drakulix) <github@drakulix.de>"
        ];
        dependencies = [
          {
            name = "libc";
      ...
      "keyframe" = rec {
        ...
        version = "1.1.1";
        edition = "2018";
        sha256 = "1afr5ffns3k79xaqnw6rw3qn8sngwly6gxfnjn8d060mk3vqnw30";
        authors = [
        ...
        resolvedDefaultFeatures = [ "alloc" "default" "mint" "mint_types" ];
      };
      "khronos-egl" = rec {
      ...
      "libsystemd" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "0vdz084zkm826z1kqlnnxh85lq6bfl6cngax0nqmcry1f5y5hi41";
        authors = [
      ...
      "orbclient" = rec {
        ...
        version = "0.3.45";
        edition = "2018";
        sha256 = "1cba581yixd0h96ra5rp77clf8fzb6vcxn4yb6yz25q6sy64h792";
        authors = [
      ...
      "ouroboros 0.13.0" = rec {
        crateName = "ouroboros";
        version = "0.13.0";
        edition = "2018";
        sha256 = "1hy9f275d94vgcjkqfrrbfzx08iwpln5938bxpxndnxls61fymzk";
        authors = [
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "ouroboros_macro 0.13.0";
          }
          {
      ...
      "ouroboros 0.15.6" = rec {
        crateName = "ouroboros";
        version = "0.15.6";
        edition = "2018";
        sha256 = "1nvjra9dana2g6kxv3397qrgpyw6lknzya6lzs1s1llbap8qndg1";
        authors = [
          "Joshua Maros <joshua-maros@github.com>"
        ];
        dependencies = [
          ...
          {
            name = "ouroboros_macro";
            packageId = "ouroboros_macro 0.15.6";
          }
        ];
        features = {
          "default" = [ "std" ];
      ...
      "ouroboros_macro 0.13.0" = rec {
        crateName = "ouroboros_macro";
        version = "0.13.0";
        edition = "2018";
        sha256 = "0mqjkckg0kzgm58graagchmbvs5gfhra9hgylpzpvvxs5hnbb824";
        procMacro = true;
        authors = [
          "Joshua Maros <joshua-maros@github.com>"
        ];
      ...
      "ouroboros_macro 0.15.6" = rec {
        crateName = "ouroboros_macro";
        version = "0.15.6";
        edition = "2018";
        sha256 = "1dsn37vds4qpkzscmwaw17dv3m5m7a7j9qby8dsac19ks3622zaz";
        procMacro = true;
        authors = [
          "Joshua Maros <joshua-maros@github.com>"
        ];
      ...
      "puffin 0.14.3" = rec {
        ...
        version = "0.14.3";
        edition = "2018";
        sha256 = "1r1z4b6ly1air9sww8xx8wa0157j6xjkgxgi5wzb17sn3yhcgcm7";
        authors = [
      ...
      "puffin 0.16.0" = rec {
        ...
        version = "0.16.0";
        edition = "2018";
        sha256 = "08ass1hfdcq86y7dywa1jylzq57la95rgpcmd6yx82hs9symlhkn";
        authors = [
          "Embark <opensource@embark-studios.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "lz4" "packing" "serde" ];
      };
      "puffin_egui" = rec {
        crateName = "puffin_egui";
        version = "0.22.0";
        edition = "2018";
        sha256 = "0pd5bksn3q59kf2scsj30xs09zrl44254jgag6lwk3jqmj3yzw00";
        authors = [
          "Emil Ernerfeldt <emil.ernerfeldt@gmail.com>"
        ];
        dependencies = [
      ...
      "renderdoc" = rec {
        ...
        version = "0.10.1";
        edition = "2018";
        sha256 = "1va3jqlbg2xnkj2fl685fnqg42ijdxxy6hdk5ssd7vsigl418bml";
        authors = [
      ...
      "resvg 0.28.0" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "1hcl2cw7f3bhvxs8r97nxzgh4r5ijay1iqw7y6f9j89n5lzqc5f1";
        authors = [
          "Yevhenii Reizner <razrfalcon@gmail.com>"
        ];
        dependencies = [
      ...
      "resvg 0.32.0" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "filter" "gif" "jpeg-decoder" "memmap-fonts" "png" "raster-images" "svgfilters" "system-fonts" "text" ];
      };
      "rgb" = rec {
        crateName = "rgb";
        version = "0.8.36";
      ...
      "roxmltree 0.15.1" = rec {
        crateName = "roxmltree";
        version = "0.15.1";
        edition = "2018";
        sha256 = "12p4vyg6c906pclhpgq8h21x1acza3dl5wk1gqp156qj3a1yk7bb";
        authors = [
          "Yevhenii Reizner <razrfalcon@gmail.com>"
        ];
        dependencies = [
      ...
      "smithay" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "02ccc8ca17fbc655d2247124fe628d276cb5179a";
          sha256 = "0ag14p5xyj3xiiz2kahcsd4w9wra89gip6vz2qjwnqywidbiipzx";
        };
        authors = [
        ...
        resolvedDefaultFeatures = [ "ash" "backend_drm" "backend_egl" "backend_gbm" "backend_libinput" "backend_session" "backend_session_libseat" "backend_udev" "backend_vulkan" "backend_winit" "backend_x11" "cc" "desktop" "drm" "drm-ffi" "encoding" "gbm" "gl_generator" "glow" "input" "libloading" "libseat" "pkg-config" "renderer_gl" "renderer_glow" "renderer_multi" "scopeguard" "tempfile" "udev" "use_system_lib" "wayland-backend" "wayland-egl" "wayland-protocols" "wayland-protocols-misc" "wayland-protocols-wlr" "wayland-server" "wayland-sys" "wayland_frontend" "winit" "x11rb" "x11rb_event_source" "xwayland" ];
      };
      ...
      "smithay-egui" = rec {
        crateName = "smithay-egui";
        version = "0.1.0";
        edition = "2021";
        workspace_member = null;
        src = pkgs.fetchgit {
          url = "https://github.com/Smithay/smithay-egui.git";
          rev = "0a4d57349ad4c9bedb25968b22b7bcb7756dd8cc";
          sha256 = "1ppik2w6q64mnzyf5wnahapc3zkq6x2r9k5w4lbnrmwfr2znql0z";
        };
        dependencies = [
          {
            name = "cgmath";
        ...
        resolvedDefaultFeatures = [ "default" "default_fonts" "desktop_integration" "egui_extras" "image" "img" "svg" ];
      };
      "snowflake" = rec {
        crateName = "snowflake";
        version = "1.3.0";
      ...
      "svgfilters" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "1kjbl0khhq548ciw2lnmkk3w2q6ncda6yzgkg7qjvp2zq7mvr6k3";
        authors = [
          "Yevhenii Reizner <razrfalcon@gmail.com>"
        ];
        dependencies = [
      ...
      "time" = rec {
        ...
        version = "0.3.24";
        edition = "2021";
        sha256 = "12rh0pa5nyibybv4can3kag8drzamg646iaqnd3ad0j8jv6sp7mp";
        authors = [
      ...
      "time-macros" = rec {
        ...
        version = "0.2.11";
        edition = "2021";
        sha256 = "1kcjzd32prdqg0lda041qihl7483grsrggymiw3vnf8nk4f52wgb";
        procMacro = true;
        authors = [
          "Jacob Pratt <open-source@jhpratt.dev>"
          "Time contributors"
      ...
      "tiny-skia 0.8.4" = rec {
        ...
        dependencies = [
          ...
          {
            name = "tiny-skia-path";
            packageId = "tiny-skia-path 0.8.4";
            usesDefaultFeatures = false;
          }
        ];
        features = {
      ...
      "tiny-skia 0.9.1" = rec {
        ...
        dependencies = [
          ...
          {
            name = "tiny-skia-path";
            packageId = "tiny-skia-path 0.9.0";
            usesDefaultFeatures = false;
          }
        ];
        features = {
      ...
      "tracing" = rec {
        ...
        resolvedDefaultFeatures = [ "attributes" "default" "max_level_debug" "release_max_level_info" "std" "tracing-attributes" ];
      };
      ...
      "udev" = rec {
        ...
        version = "0.7.0";
        edition = "2015";
        sha256 = "06hr927z0fdn7ay0p817b9x19i5fagmpmvz95yhl4d1pf3bbpgaf";
        authors = [
          "David Cuddeback <david.cuddeback@gmail.com>"
          "Victoria Brekenfeld <github@drakulix.de>"
        ];
      ...
      "usvg 0.28.0" = rec {
        ...
        version = "0.28.0";
        edition = "2018";
        sha256 = "1s9jyjmi51v9916cmw48q8ky7ihcw84kvjk7q1436nw460mpqnwb";
        authors = [
          "Yevhenii Reizner <razrfalcon@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "imagesize";
            packageId = "imagesize 0.10.1";
          }
          {
            name = "kurbo";
            packageId = "kurbo 0.8.3";
          }
          {
            name = "log";
            packageId = "log";
      ...
      "vec1" = rec {
        ...
        version = "1.10.1";
        edition = "2021";
        sha256 = "0p4xrrgqpzxlg7q74aqwxgsyfjsz0ppfgabqqahyj7rkr90prnib";
        authors = [
      ...
      "wayland-sys 0.30.1" = rec {
        ...
        resolvedDefaultFeatures = [ "client" "dlopen" "egl" "lazy_static" "libc" "memoffset" "server" ];
      };
      "web-sys" = rec {
        crateName = "web-sys";
        version = "0.3.64";
      ...
      "winit" = rec {
        ...
        version = "0.28.6";
        edition = "2021";
        sha256 = "15pi8wnjnams3nsplnwc2pyym2kw6p7xw35z65fsgyzz2bvv6vc6";
        authors = [
        ...
        resolvedDefaultFeatures = [ "mio" "percent-encoding" "sctk" "wayland" "wayland-client" "wayland-commons" "wayland-dlopen" "wayland-protocols" "x11" "x11-dl" ];
      };
      "winnow" = rec {
        crateName = "winnow";
        version = "0.5.2";
      ...
      "x11rb" = rec {
        ...
        resolvedDefaultFeatures = [ "allow-unsafe-code" "composite" "dl-libxcb" "dri3" "libc" "libloading" "once_cell" "present" "randr" "render" "shape" "shm" "sync" "xfixes" ];
      };
      "x11rb-protocol" = rec {
        ...
        resolvedDefaultFeatures = [ "composite" "default" "dri3" "nix" "present" "randr" "render" "shape" "shm" "std" "sync" "xfixes" ];
      };
      "xcursor" = rec {
        crateName = "xcursor";
        version = "0.3.4";
      ...
      "xkbcommon 0.4.1" = rec {
        ...
        version = "0.4.1";
        edition = "2015";
        sha256 = "1kr8ik92ckz12s9my66a7grip84n87xgkannpchi5hsmqw6d0bh3";
        authors = [
