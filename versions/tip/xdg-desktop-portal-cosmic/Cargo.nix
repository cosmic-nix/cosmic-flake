    ...
    crates = {
      ...
      "ashpd" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "c67c9cbaf8c02490b10ff976c48306dfa2d9bff6";
          sha256 = "1219vagaxqx972qiv290xii60zqi4321gpkdfmfwij59q6m09ss0";
        };
        authors = [
      ...
      "libspa" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "b530b3d39463a5918808841e453f6c662fd6e03b";
          sha256 = "0xrg017n94bxg4d8fq5g5gr752h386vgv5xjc9k17ni6b4sm6wj4";
        };
        authors = [
      ...
      "memchr" = rec {
        ...
        version = "2.6.0";
        edition = "2021";
        sha256 = "0b0y8n7w277y7nll8mr3nvd903r9xwmgcv1wpinl6nwdb3i49z3n";
        authors = [
          "Andrew Gallant <jamslam@gmail.com>"
          "bluss"
        ];
      ...
      "nix 0.26.3" = rec {
        ...
        version = "0.26.3";
        edition = "2018";
        sha256 = "00m55s9sisljfza0mm6agzh69f51rmnpj720z62sqfmisxdcbfxb";
        authors = [
          "The nix-rust Project Developers"
        ];
        dependencies = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "combaseapi" "errhandlingapi" "handleapi" "iphlpapi" "knownfolders" "libloaderapi" "memoryapi" "minwinbase" "ntdef" "processthreadsapi" "sddl" "securitybaseapi" "shlobj" "synchapi" "tcpmib" "winbase" "winerror" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
