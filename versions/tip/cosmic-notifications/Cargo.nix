...
rec {
  ...
  workspaceMembers = {
    "cosmic-notifications" = rec {
      packageId = "cosmic-notifications";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "console-subscriber" = rec {
        ...
        version = "0.1.9";
        edition = "2021";
        sha256 = "1ivz302vdf83m01hhxhay6qzfi46y6m4rfmd0gmq459il0j25asp";
        authors = [
          "Eliza Weisman <eliza@buoyant.io>"
          "Tokio Contributors <team@tokio.rs>"
        ];
      ...
      "cosmic-config" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "f17d52f37f06f4d35c2feb65a5da03516d374acf";
          sha256 = "1ycnmij667vsqijap0jwyarxc8rqpf067pc0kwwzz3sv0bnvq32g";
        };
        dependencies = [
          {
            name = "atomicwrites";
      ...
      "cosmic-notifications" = rec {
        crateName = "cosmic-notifications";
        version = "0.1.0";
        edition = "2021";
        crateBin = [
          {
        ...
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "sync" "rt" "tracing" "macros" "net" "io-util" ];
          }
          {
            name = "tracing";
            packageId = "tracing";
      ...
      "cosmic-notifications-config" = rec {
        ...
        # See https://github.com/NixOS/nix/issues/5410
        src = if ((lib.versionOlder builtins.nixVersion "2.4pre20211007") || (lib.versionOlder "2.5" builtins.nixVersion ))
          then lib.cleanSourceWith { filter = sourceFilter;  src = ./cosmic-notifications-config; }
          else ./cosmic-notifications-config;
        dependencies = [
          {
            name = "cosmic-config";
      ...
      "cosmic-notifications-util" = rec {
        ...
        # See https://github.com/NixOS/nix/issues/5410
        src = if ((lib.versionOlder builtins.nixVersion "2.4pre20211007") || (lib.versionOlder "2.5" builtins.nixVersion ))
          then lib.cleanSourceWith { filter = sourceFilter;  src = ./cosmic-notifications-util; }
          else ./cosmic-notifications-util;
        dependencies = [
          {
            name = "bytemuck";
            packageId = "bytemuck";
